            ...
            <div className="mx-auto max-w-3xl flex items-center gap-3">
              ...
              <div className="relative flex-1">
                <input
                  ...
                  placeholder="Search…"
                  className="w-full h-10 pl-5 pr-12 rounded-full bg-white dark:bg-gray-600 text-black dark:text-white  border border-primary/40 focus:outline-none focus:ring-2 focus:ring-pink-400/50"
                />
