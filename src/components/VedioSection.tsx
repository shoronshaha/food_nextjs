...
export default function ProductVideosSlider() {
  ...
  return (
    <div className='w-full overflow-hidden bg-orange-50 dark:bg-gray-900 text-black dark:text-white relative font-urbanist'>
      {/* Background Effects */}
      <div className='fixed inset-0 pointer-events-none overflow-hidden -z-10'>
        <div className={`absolute top-1/4 left-1/4 w-48 sm:w-64 md:w-96 h-48 sm:h-64 md:h-96 bg-orange-500/10 rounded-full blur-xl sm:blur-2xl md:blur-3xl animate-pulse ${isMobile ? '' : 'transform-gpu'}`}></div>
        <div className={`absolute bottom-1/4 right-1/4 w-48 sm:w-64 md:w-96 h-48 sm:h-64 md:h-96 bg-red-500/10 rounded-full blur-xl sm:blur-2xl md:blur-3xl animate-pulse ${isMobile ? '' : 'transform-gpu'}`} style={{ animationDelay: '2s' }}></div>
        <div className={`absolute top-1/2 right-1/3 w-32 sm:w-48 md:w-72 h-32 sm:h-48 md:h-72 bg-yellow-500/10 rounded-full blur-xl sm:blur-2xl md:blur-3xl animate-pulse ${isMobile ? '' : 'transform-gpu'}`} style={{ animationDelay: '4s' }}></div>
      </div>
      ...
      <div className={`relative px-2 py-4 sm:py-8 w-full ${isMobile ? '' : 'perspective-1000'}`}>
        <div className='mx-auto w-full'>
            ...
            <button
              ...
              className={`group relative p-2 sm:p-3 md:p-4 bg-white/80 dark:bg-gray-700/80 backdrop-blur-xl hover:bg-orange-50 dark:hover:bg-gray-600 rounded-2xl shadow-2xl border border-orange-200/50 dark:border-gray-600/50 transition-all duration-500 hover:scale-110 hover:-translate-y-2 hover:shadow-orange-500/20 z-20 ${isMobile ? '' : 'transform-gpu'}`}
              style={isMobile ? {} : { transform: isTransitioning ? 'rotateY(-15deg) scale(0.95)' : 'rotateY(-5deg)', transformStyle: 'preserve-3d' }}
              aria-label='Previous video'
            >
              <div className={`absolute inset-0 bg-gradient-to-r from-orange-500/20 to-red-500/20 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 ${isMobile ? '' : 'transform-gpu'}`}></div>
              <BiChevronLeft className='w-6 h-6 sm:w-5 sm:h-5 md:w-6 md:h-6 text-gray-700 dark:text-white group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-all duration-300 transform-gpu group-hover:scale-110' />
            </button>
