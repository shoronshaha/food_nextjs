...
export default function SimpleLoadingSkeleton({
  ...
  return (
    <div
      className={`animate-pulse bg-organic-50 rounded-md ${height} ${className}`}
    ></div>
  );
}
...
export function ProductSkeleton() {
  return (
    <div className="border rounded-2xl p-4 space-y-3 border-organic-100 shadow-organic">
      <SimpleLoadingSkeleton className="w-full rounded-xl" height="h-48" />
