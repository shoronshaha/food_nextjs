...
export const MenuSidebar = () => {
  ...
  return (
    <div className="fixed inset-0 z-40 flex ">
      ...
      <div
        ref={sidebarRef}
        className="relative bg-white dark:bg-gray-600 w-64 md:w-80 h-full shadow-lg z-50 p-6 overflow-y-auto mb-10"
      ...
      >
        ...
        <ul className="flex flex-col gap-1 text-black dark:text-white md:mb-10 mb-20">
