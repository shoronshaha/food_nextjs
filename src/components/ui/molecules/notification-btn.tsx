    ...
    <Dropdown align="right" className="relative">
      ...
      <DropdownContent className="w-fit sm:w-72 rounded-lg shadow-lg bg-white dark:bg-gray-700 fixed sm:absolute left-2 sm:left-auto right-2 sm:right-0 mt-2">
        {/* <div className='flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700'>
          ...
          <Link
            to={'/notifications'}
            className='text-primary hover:text-primary dark:text-primary/80 dark:hover:text-primary/70 hover:underline text-nowrap'
          >
            View All
          </Link>
        </div>
              ...
              >
                <div className="shrink-0">
                  <Image
                    ...
                    height={50}
                  />
                  <div className="absolute flex items-center justify-center w-5 h-5 ms-6 -mt-5 bg-primary border border-white rounded-full dark:border-gray-800">
                    <svg
