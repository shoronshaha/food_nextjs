...
const Footer = function Footer({ business }: FooterProps) {
  ...
  return (
    <footer className='w-full bg-white dark:bg-black'>
      ...
      <div className='bg-primary/15'></div>
      ...
      <div className=' px-4 sm:px-6 py-10'>
        <div className='grid grid-cols-1 md:grid-cols-12 gap-8'>
          ...
          <div className='md:col-span-4 flex flex-col items-center md:items-start'>
            ...
            <p className='mt-6 text-sm leading-7 text-gray-600 dark:text-gray-300 text-center md:text-left'>
              Taste the difference with our handcrafted meals. Fresh ingredients, authentic recipes, and delivery with a smile.
            </p>
          </div>
          {/* Explore More */}
