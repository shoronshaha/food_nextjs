...
export default function RelatedProducts({
    ...
    return (
      <section ref={sectionRef} className="py-10">
        <div className="flex items-center justify-center gap-4 mb-8">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-gray-900 via-primary to-gray-900 dark:from-white dark:via-primary dark:to-white font-urbanist tracking-wide">
            RECOMMENDED DISHES
          </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-8">
          {Array.from({ length: 4 }).map((_, idx) => (
            <div
              key={idx}
              className="bg-white/40 dark:bg-white/5 backdrop-blur-sm border border-white/20 rounded-2xl h-[350px] animate-pulse relative overflow-hidden"
            >
  ...
  return (
    <section ref={sectionRef} className="py-10 relative">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-full bg-primary/5 blur-[100px] -z-10 rounded-full pointer-events-none"></div>

      <div className="flex items-center justify-center gap-4 mb-10">
        <div className="h-[1px] w-16 bg-gradient-to-r from-transparent to-primary/30"></div>
        <h2 className="text-2xl md:text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-gray-900 via-primary to-gray-900 dark:from-white dark:via-primary dark:to-white font-urbanist tracking-wider uppercase">
          Recommended Dishes
        </h2>
        <div className="h-[1px] w-16 bg-gradient-to-l from-transparent to-primary/30"></div>
      </div>
