      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center border border-gray-200 rounded">
            <button
              type="button"
              className="w-9 h-9 flex items-center justify-center bg-organic-50 hover:bg-organic-100 rounded-l-md disabled:opacity-30 transition-colors"
            ...
            <input
              ...
              className="w-14 h-9 text-center text-sm border-x border-organic-100 focus:outline-none focus:ring-2 focus:ring-organic-200"
            />
            <button
              type="button"
              className="w-9 h-9 flex items-center justify-center bg-organic-50 hover:bg-organic-100 rounded-r-md disabled:opacity-30 transition-colors"
              onClick={() => onQuantityChange(quantity + 1)}
        ...
        <div className="flex items-center gap-2">
          <AddToWishlistBtn
            ...
            size="icon"
            className="h-10 w-10 p-2 bg-organic-50 rounded-lg border border-organic-100 hover:bg-organic-100 transition-colors"
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 text-sm text-earth-700 bg-organic-50 hover:bg-organic-100 border border-organic-100 rounded-full transition-colors shadow-sm"
            aria-label="Share"
          >
            <BiShare className="w-5 h-5 text-organic-700" />
            <span>Share</span>
          </button>
        </div>
      </div>
