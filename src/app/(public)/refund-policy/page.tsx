...
export default function RefundPolicyPage() {
  ...
  const policyData = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: <FiAlertTriangle className="w-5 h-5 text-tertiary" />,
        },
      ],
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-gradient-to-r from-primary/5 to-secondary/5 dark:from-primary/10 dark:to-secondary/10 p-6 rounded-xl border border-primary/20 dark:border-primary/50">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              Email us with your order ID and reason for return. We will issue a
              Return Authorization (RA) number and arrange collection or
              drop-off.
            </p>
            <a
              href="mailto:support@yourcompany.com"
              className="inline-flex items-center px-6 py-3 bg-primary text-white rounded-full hover:bg-secondary transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
            ...
            <div className="text-center p-4 bg-white dark:bg-slate-800 rounded-xl shadow-md">
              <div className="w-12 h-12 bg-gradient-to-r from-tertiary to-primary rounded-full flex items-center justify-center mx-auto mb-3">
    ...
    },
    {
      ...
      bgColor:
        "from-tertiary/5 to-primary/5 dark:from-tertiary/10 dark:to-primary/10",
      borderColor: "tertiary",
      content: (
        <div className="space-y-4">
          <div className="bg-gradient-to-r from-tertiary/5 to-primary/5 dark:from-tertiary/10 dark:to-primary/10 p-6 rounded-xl border border-tertiary/20 dark:border-tertiary/50">
            <div className="flex items-center space-x-3 mb-4">
              <CgLock className="w-8 h-8 text-tertiary" />
              <div>
                <h4 className="font-semibold text-gray-800 dark:text-gray-200">
                  7-10 Working Days
                </h4>
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              approval or rejection of your refund. Approved refunds are
              credited back to your original payment method within{" "}
              <span className="font-bold text-primary">7–10 working days</span>.
            </p>
    ...
    },
    {
      ...
      bgColor:
        "from-primary/5 to-tertiary/5 dark:from-primary/10 dark:to-tertiary/10",
      borderColor: "primary",
      content: (
        <div className="space-y-4">
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 p-6 rounded-xl border border-green-200 dark:border-green-800">
            ...
            <p className="text-gray-700 dark:text-gray-300">
              Orders can be cancelled at no cost{" "}
              <span className="font-bold text-green-600 dark:text-green-400">
                before they are dispatched
              </span>
              . If your order has already been shipped, please follow the return
              procedure above.
            </p>
          </div>
          <div className="bg-secondary/5 dark:bg-gray-800 p-6 rounded-xl border border-secondary/20 dark:border-gray-700">
            <div className="flex items-center space-x-3 mb-4">
            ...
            <p className="text-gray-700 dark:text-gray-300">
              Once shipped, standard return policies apply with potential
              shipping charges.
            </p>
          </div>
        </div>
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-gradient-to-r from-primary/5 to-secondary/5 dark:from-primary/10 dark:to-secondary/10 p-6 rounded-xl border border-primary/20 dark:border-primary/50">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              We do not offer refunds for items that show signs of misuse,
              intentional damage, or are returned after the 7-day window.
            </p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-tertiary/5 to-secondary/5 dark:from-slate-900 dark:via-primary/10 dark:to-secondary/10 md:mt-16 mt-0">
      ...
      <main
        className={`relative mx-auto max-w-7xl md:px-4 px-2 py-6 transform transition-all duration-1000 ${
      ...
      >
        ...
        <div className="text-center md:mb-16 mb-8">
          ...
          <h1 className="md:text-5xl text-xl font-bold bg-primary bg-clip-text text-transparent mb-4">
            Refund & Return Policy
          </h1>
          <p className="text-sm md:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Read our refund, return, and cancellation terms with complete
            transparency and easy-to-understand guidelines.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6 md:mb-12 mb-5">
          ...
          <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl md:p-6 p-2 text-center shadow-xl border border-white/20 dark:border-slate-700/20">
            <div className="w-12 h-12 bg-gradient-to-r from-primary to-tertiary rounded-full flex items-center justify-center mx-auto mb-3">
              <BiPackage className="w-6 h-6 text-white" />
            </div>
            <h3 className="text-2xl font-bold text-gray-800 dark:text-gray-200">
              Easy
              ...
              <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 dark:border-slate-700/20 overflow-hidden hover:shadow-2xl transition-all duration-300">
                ...
                >
                  <div className="flex items-center space-x-2">
                    <div
                      className={`flex items-center justify-center md:w-12 w-8 md:h-12 h-8 bg-gradient-to-r ${section.color} rounded-xl text-white shadow-lg`}
                    >
                      {section.icon}
                    </div>
                    <div>
                    ...
                    {section.content || (
                      <div className="space-y-4 mb-2">
                        {section.items.map((item, itemIndex) => (
                          <div
                            key={itemIndex}
                            className={`flex items-start space-x-3 p-4 rounded-lg bg-gradient-to-r ${section.bgColor} border border-${section.borderColor}/20 dark:border-${section.borderColor}/50`}
                          >
                            {item.icon}
          ...
          <div className="bg-primary p-0.5 rounded-2xl">
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button className="inline-flex items-center text-sm md:text-xl md:px-8 px-3 py-3 bg-primary text-white rounded-full hover:bg-secondary transition-all duration-300 transform hover:scale-105 shadow-lg">
