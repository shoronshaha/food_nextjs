  ...
  const policyData = [
    {
      ...
      bgColor: "from-primary/5 to-secondary/5 dark:from-primary/10 dark:to-secondary/10",
      borderColor: "primary",
      items: [
        {
    ...
    },
    {
      ...
      bgColor: "from-secondary/5 to-primary/5 dark:from-secondary/10 dark:to-primary/10",
    ...
    },
    {
      ...
      bgColor: "from-tertiary/5 to-primary/5 dark:from-tertiary/10 dark:to-primary/10",
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-gradient-to-r from-tertiary/5 to-primary/5 dark:from-tertiary/10 dark:to-primary/10 p-6 rounded-xl border border-tertiary/20 dark:border-tertiary/50">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              Once we receive and inspect your return, we will notify you of the approval or rejection of your refund. Approved refunds are credited back to your original payment method within <span className="font-bold text-primary">7–10 working days</span>.
            </p>
    ...
    },
    {
      ...
      bgColor: "from-primary/5 to-tertiary/5 dark:from-primary/10 dark:to-tertiary/10",
      borderColor: "primary",
      content: (
        <div className="space-y-4">
                    ...
                    {section.content || (
                      <div className="space-y-4 mb-2">
                        {section.items.map((item, itemIndex) => (
                          <div key={itemIndex} className={`flex items-start space-x-3 p-4 rounded-lg bg-gradient-to-r ${section.bgColor} border border-${section.borderColor}/20 dark:border-${section.borderColor}/50`}>
                            {item.icon}
