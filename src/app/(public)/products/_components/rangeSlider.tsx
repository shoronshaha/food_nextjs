...
const RangePriceFilter: React.FC<RangePriceFilterProps> = ({
  ...
  console.log(
    "RangePriceFilter - initialMinPrice:",
    initialMinPrice,
    "initialMaxPrice:",
    initialMaxPrice
  );
    ...
    <div className="space-y-3 font-urbanist">
      ...
      <div className="flex flex-col gap-2">
        <div className="relative w-full h-[6px] bg-gray-200 dark:bg-gray-700 rounded-full">
          ...
          <div
            className="absolute h-[6px] bg-primary rounded-full z-[1]"
            style={{
              left: `${
                ((minSliderValue - MIN_PRICE) / (MAX_PRICE - MIN_PRICE)) * 100
              }%`,
              right: `${
                100 -
                ((maxSliderValue - MIN_PRICE) / (MAX_PRICE - MIN_PRICE)) * 100
              }%`,
            }}
          />
