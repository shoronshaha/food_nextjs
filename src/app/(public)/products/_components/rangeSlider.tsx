...
const RangePriceFilter: React.FC<RangePriceFilterProps> = ({
    ...
    return (
        <div className="space-y-3 font-urbanist">
            <span className="font-semibold text-black dark:text-white">Price Range</span>
            <div className="flex flex-col gap-2">
                <div className="relative w-full h-[6px] bg-gray-200 dark:bg-gray-700 rounded-full">
                    {/* Active range between min and max */}
                    <div
                        className="absolute h-[6px] bg-orange-500 rounded-full z-[1]"
                        style={{
                    ...
                    <input
                        ...
                        className="absolute w-full h-2.5 bg-transparent appearance-none z-[2] cursor-pointer accent-orange-600"
