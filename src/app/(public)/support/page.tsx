...
const SupportPage = () => {
    /* State */
    const [activeTab, setActiveTab] = useState<'contact' | 'live-chat' | 'resources' | 'status'>('contact');
    ...
    const getStatusColor = (status: string) => {
        const colors: Record<string, string> = {
            ...
            outage: 'text-primary bg-primary/10 dark:text-primary dark:bg-primary/20',
        };
    ...
    const getStatusIcon = (status: string) => {
        ...
        return icons[status] || FiHelpCircle;
    };
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {supportOptions.map((o) => (
                        <button
                            ...
                            className={`bg-white dark:bg-slate-800 rounded-2xl shadow-lg hover:shadow-xl transition-all p-6 text-left group ${activeTab === o.id ? 'ring-2 ring-primary' : ''
                                }`}
                        >
                            <div
                                className={`w-12 h-12 bg-gradient-to-br ${o.gradient} rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
                            >
                ...
                {activeTab === 'contact' && (
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <section className="lg:col-span-2">
                            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg md:p-8 p-2">
                                ...
                                <form onSubmit={handleFormSubmit} className="space-y-6">
                                        ...
                                        {[
                                            ...
                                            <div key={name}>
                                                ...
                                                <input
                                                    ...
                                                    required={required}
                                                    className="w-full md:px-4 px-2 py-3 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-slate-800 text-gray-800 dark:text-gray-100 focus:ring-2 focus:ring-primary focus:border-transparent"
                                                />
                                            </div>
                                        ))}
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            onChange={handleInputChange}
                                            className="w-full px-4 py-3 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-slate-800 text-gray-800 dark:text-gray-100 focus:ring-2 focus:ring-primary focus:border-transparent"
                                        >
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            onChange={handleInputChange}
                                            className="w-full px-4 py-3 border border-gray-300 dark:border-gray-700 rounded-lg resize-none bg-white dark:bg-slate-800 text-gray-800 dark:text-gray-100 focus:ring-2 focus:ring-primary focus:border-transparent"
                                        />
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between">
                                        <button
                                            type="button"
                                            className="flex items-center gap-2 text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary"
                                        >
                        ...
                        <aside className="space-y-6">
                            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-6">
                                ...
                                <ul className="space-y-4">
                                    {contactMethods.map((m) => (
                                        <li
                                            key={m.title}
                                            className="flex items-start gap-4 p-4 rounded-lg hover:bg-primary/5 dark:hover:bg-primary/10 transition-colors"
                                        >
                                            ...
                                            <div>
                                                ...
                                                <p className="text-primary dark:text-primary text-xs font-medium mt-1">
                                                    {m.availability}
                                                </p>
                                            </div>
                                        </li>
                            ...
                            <div className="bg-white dark:bg-slate-800 rounded-2xl p-6">
                                ...
                                <button className="w-full bg-primary hover:bg-secondary text-white py-2 rounded-lg font-semibold transition-colors">
                                    Learn More
                                </button>
                            </div>
                        </aside>
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg overflow-hidden">
                        ...
                        <div className="bg-gradient-to-r from-primary to-secondary text-white p-6 flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-white/80">Connected with Agent Sarah</p>
                            </div>
                        ...
                        <div className="h-96 overflow-y-auto p-6 space-y-4">
                            {chatMessages.map((m) => (
                                <div key={m.id} className={`flex ${m.type === 'user' ? 'justify-end' : 'justify-start'}`}>
                                    ...
                                    >
                                        <p>{m.message}</p>
                                        <p
                                            className={`text-xs mt-1 ${m.type === 'user' ? 'text-white/70' : 'text-gray-500 dark:text-gray-400'
                                                }`}
                                        >
                                            {m.time}
                                        </p>
                            ...
                            {isTyping && (
                                <div className="flex justify-start">
                                    <div className="bg-gray-100 dark:bg-slate-700 text-gray-800 dark:text-gray-100 px-4 py-2 rounded-lg">
                        ...
                        <div className="p-6 border-t border-gray-200 dark:border-gray-700">
                            <div className="flex gap-4">
                                <input
                                    ...
                                    className="flex-1 px-4 py-3 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-slate-800 text-gray-800 dark:text-gray-100 focus:ring-2 focus:ring-primary focus:border-transparent"
                                />
                                <button
                                    onClick={sendMessage}
                    ...
                    <section className="space-y-8">
                        ...
                        <div className="max-w-2xl mx-auto">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-12 pr-4 py-3 border border-gray-300 dark:border-gray-700 rounded-xl bg-white dark:bg-slate-800 text-gray-800 dark:text-gray-100 focus:ring-2 focus:ring-primary focus:border-transparent"
                                />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            {helpResources.map((section) => (
                                <article key={section.category} className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-6">
                                    <h3 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-4">
                                        {section.category}
                                    </h3>
                                    <ul className="space-y-4">
                                        {section.articles.map((a) => (
                                            <li key={a.title} className="border-b border-gray-100 dark:border-gray-700 pb-4 last:border-b-0">
                                                <h4 className="font-semibold text-gray-800 dark:text-gray-100 hover:text-primary cursor-pointer mb-2">
                                                    {a.title}
                                                </h4>
                                                <div className="flex items-center justify-between text-xs text-gray-600 dark:text-gray-400">
                                                    <span>{a.views} views</span>
                                                    <span className="flex items-center gap-1">
                                                        <SiTarget className="w-4 h-4 text-primary fill-primary" />
                                                        {a.helpful}% helpful
                                                    </span>
                                                </div>
                                            </li>
                                    ...
                                    <button className="w-full mt-4 text-primary hover:text-secondary dark:hover:text-primary font-semibold flex items-center justify-center gap-2">
                                        View All Articles
                ...
                {activeTab === 'status' && (
                    <section className="space-y-8">
                        ...
                        <div className="bg-gradient-to-br from-primary/10 to-secondary/10 dark:from-primary/20 dark:to-secondary/20 rounded-2xl p-8">
                            ...
                            <button className="bg-primary hover:bg-secondary text-white px-6 py-2 rounded-lg font-semibold transition-colors">
                                View SLA Details
                            </button>
                        </div>
                    </section>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <a
                            ...
                            className="bg-white text-primary hover:bg-primary/10 px-8 py-3 rounded-lg font-semibold flex items-center gap-2 transition-colors"
                        >
                            <BiPhone className="w-5 h-5" />
                            Call Now: +880 1855-375963
                        </a>
                        <button className="bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white px-8 py-3 rounded-lg font-semibold flex items-center gap-2 transition-colors">
